...
logf = "./data/ycombinator"

class YCombinator(commands.Cog):
    ...
    async def parser(self):
        feed = feedparser.parse('https://hnrss.org/best')
...
async def setup(client):
    await client.add_cog(YCombinator(client))